...
const styles = StyleSheet.create({
  searchShell: { minHeight: 52, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface }, searchIcon: { fontSize: 24, color: colors.textMuted }, search: { ...typography.bodyMD, color: colors.textPrimary, flex: 1, minHeight: 50 }, scroller: { flexGrow: 0 }, filters: { gap: spacing.xs, paddingRight: spacing.lg }, filter: { minWidth: 76, height: 40, paddingHorizontal: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: radius.pill, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface }, filterSelected: { borderColor: colors.primary, backgroundColor: '#3A1D0C' }, filterText: { ...typography.caption, color: colors.textSecondary, textAlign: 'center' }, filterTextSelected: { color: colors.primary }, resultHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: spacing.sm }, resultCount: { ...typography.caption, color: colors.titanium }, resultHint: { ...typography.caption, color: colors.textMuted }, grid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', gap: spacing.sm }, tile: { width: '48%' }, pressed: { opacity: .76, transform: [{ scale: .985 }] }, exerciseCard: { padding: 0, overflow: 'hidden', gap: 0 }, thumbnail: { width: '100%', height: 92, backgroundColor: colors.surfaceElevated }, exerciseCopy: { minHeight: 82, padding: spacing.sm, gap: spacing.xxs }, exerciseName: { ...typography.bodyMD, color: colors.textPrimary, fontFamily: 'MontserratSemiBold' }, exerciseMeta: { ...typography.caption, color: colors.textMuted }, info: { gap: spacing.xs, backgroundColor: colors.surfaceElevated }, infoTitle: { ...typography.caption, color: colors.titaniumLight }, infoCopy: { ...typography.bodyMD, color: colors.textSecondary },
});
