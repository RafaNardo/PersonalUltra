...
export type StudentNutrition = { id: string; name: string; notes: string; updatedAt: string; responsibleTrainerName: string; meals: Array<{ id: string; name: string; sequence: number; notes: string; foods: Array<{ id: string; foodName: string; quantity: number; unit: NutritionQuantityUnit; sequence: number }> }> };
