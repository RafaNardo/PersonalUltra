...
export type TrainerNutritionInput = { name: string; notes?: string; dailyGoals?: NutritionDailyGoals; meals: Array<{ name: string; sequence: number; notes?: string; foods: Array<{ foodName: string; quantity: number; unit: NutritionQuantityUnit; sequence: number }> }> };
