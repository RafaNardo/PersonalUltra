...
export default function TrainerStudentWorkoutScreen() {
  ...
  return <Screen style={styles.page}>
    ...
    <View style={styles.sectionHeader}><Text style={styles.sectionTitle}>Exercícios prescritos</Text><Text style={styles.count}>{workoutData.exercises.length}</Text></View>
    ...
    <Card style={styles.readOnlyNotice}><Text style={styles.noticeTitle}>Visualização da prescrição</Text><Text style={styles.copy}>Este shell apresenta exatamente o treino disponível para o aluno.</Text></Card>
  </Screen>;
}
