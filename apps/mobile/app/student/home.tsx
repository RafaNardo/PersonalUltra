...
export default function HomeScreen() {
  ...
  return <Screen>
    <TopBar eyebrow="Personal Ultra" title={home.data.greeting} action={<Pressable onPress={signOut}><Text style={styles.exit}>Sair</Text></Pressable>} />
