...
export default function InviteCodeScreen() {
  ...
  const invite = useQuery({ queryKey: ['student-invite-code', normalizedCode], queryFn: () => inviteApi.resolveCode(normalizedCode), enabled: normalizedCode.length === 6, retry: false });
