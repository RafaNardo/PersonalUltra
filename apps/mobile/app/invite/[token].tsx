...
export default function InviteEntryScreen() {
  ...
  const accept = useMutation({ mutationFn: (input: { firstName: string; lastName: string; email?: string; phone: string }) => inviteApi.accept(token, input) });
