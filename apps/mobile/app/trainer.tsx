...
const styles = StyleSheet.create({
  ...
  section: { gap: spacing.sm }, sectionTitle: { ...typography.headingMD, color: colors.textPrimary }, student: { gap: spacing.xs }, studentHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm }, studentName: { ...typography.headingMD, color: colors.textPrimary, flex: 1 }, studentEmail: { ...typography.bodyMD, color: colors.textSecondary },
});
