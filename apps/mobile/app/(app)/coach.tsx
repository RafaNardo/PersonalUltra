...
export default function CoachScreen() {
  ...
  return <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}><Screen scroll><TopBar eyebrow="Hoje · SVR Method" title="SVR Coach" action={<Image source={avatar} style={styles.topAvatar} />} />
    ...
    <View style={styles.quickHeader}><Text style={styles.quickTitle}>COMO POSSO AJUDAR?</Text><Pressable accessibilityRole="button" accessibilityLabel="Registrar dor" accessibilityHint="Abre o registro de dor" onPress={() => router.push('/(app)/pain')}><Text style={styles.painLink}>Registrar dor</Text></Pressable></View>
