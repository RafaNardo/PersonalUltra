...
internal static class ExerciseCatalogSeed
{
    ...
    [
        ...
        new("10000000-0000-0000-0000-000000000009", "Tríceps na polia com corda", "triceps-na-polia-com-corda", "Braços", "Cabo", "triceps-na-polia-com-corda", "Mantenha os cotovelos próximos ao corpo durante toda a extensão."),
        new("10000000-0000-0000-0000-000000000010", "Rosca direta com barra", "rosca-direta-com-barra", "Braços", "Barra", "rosca-direta-com-barra", "Evite impulsionar o corpo e mantenha os cotovelos estáveis."),
        new("10000000-0000-0000-0000-000000000011", "Agachamento livre", "agachamento-livre", "Pernas", "Barra", "agachamento_livre", "Desça com controle mantendo os joelhos alinhados aos pés."),
        new("10000000-0000-0000-0000-000000000012", "Agachamento goblet", "agachamento-goblet", "Pernas", "Halter", "agachamento_goblet", "Segure o halter junto ao peito e mantenha o tronco firme."),
        new("10000000-0000-0000-0000-000000000013", "Agachamento sumô", "agachamento-sumo", "Pernas", "Barra", "agachamento_sumo", "Use uma base ampla e acompanhe a linha dos pés com os joelhos."),
        new("10000000-0000-0000-0000-000000000014", "Cadeira extensora", "cadeira-extensora", "Pernas", "Máquina", "cadeira_extensora", "Faça a extensão sem chutar a carga e retorne lentamente."),
        new("10000000-0000-0000-0000-000000000015", "Cadeira flexora", "cadeira-flexora", "Pernas", "Máquina", "cadeira_flexora", "Mantenha o quadril apoiado e controle o retorno da flexão."),
        new("10000000-0000-0000-0000-000000000016", "Leg press 45°", "leg-press-45", "Pernas", "Máquina", "leg_press_45", "Não trave os joelhos e mantenha a lombar apoiada no encosto."),
        new("10000000-0000-0000-0000-000000000017", "Passada com halteres", "passada-com-halteres", "Pernas", "Halteres", "passada_com_halteres", "Dê um passo firme e mantenha o joelho acompanhando o pé."),
        new("10000000-0000-0000-0000-000000000018", "Step-up com halteres", "step-up-com-halteres", "Pernas", "Halteres", "step_up_com_halteres", "Suba usando a perna apoiada no banco, sem impulsionar com a de trás."),
        new("10000000-0000-0000-0000-000000000019", "Stiff com barra", "stiff-com-barra", "Pernas", "Barra", "stiff_com_barra", "Leve o quadril para trás mantendo a coluna neutra."),
        new("10000000-0000-0000-0000-000000000020", "Levantamento terra romeno", "levantamento-terra-romeno", "Pernas", "Barra", "levantamento-terra-romeno", "Mantenha a barra próxima às pernas durante a descida."),
