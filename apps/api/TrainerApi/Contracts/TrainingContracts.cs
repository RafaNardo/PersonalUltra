...
public sealed record WorkoutTemplateExerciseInput(string Name, int Sequence, int Sets, int Repetitions, int RestSeconds, string? Notes);
...
public sealed record WorkoutTemplateResponse(Guid Id, string Name, string Notes, IReadOnlyList<WorkoutTemplateExerciseInput> Exercises);
